...
export default function SideBar({
  ...
  return (
    <div className="grid col-start-1 row-start-1 items-start">
      <div
        className={`z-50 bg-base-800 h-full border-r transition-transform duration-300 ease-in-out ${
      ...
      <ChevronRightIcon
        ...
        width="24"
        height="24"
        className={`hover:text-base-600 cursor-pointer absolute top-0 left-0 transition-all duration-300 ${
